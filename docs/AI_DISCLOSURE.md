...
Concept ideation, choosing the project direction, architecture design, the data-model / schema spec, the demo walkthrough, this README, and this disclosure. AI acted as a planning partner; all strategic decisions (track choice, scope cuts, what to build and what to skip) were made by the team.
...
All commits are authored by the team's human participants. AI-generated output was treated as a draft to be reviewed, tested, and accepted, not shipped unverified.
